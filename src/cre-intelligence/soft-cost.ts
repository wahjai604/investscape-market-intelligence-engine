/**
 * InvestScape™ E68 Phase 5 — soft costs (Part 7).
 * © 2026 Lighthouse Research Ltd. All rights reserved.
 *
 * E68 has zero verified soft-cost observations (RLB's North America report is
...
export function getSoftCostBenchmark(identity: SoftCostResponse["identity"]): SoftCostResponse {
  return {
    ...
    identity,
    reason:
      "E68 has not researched or verified any soft-cost data source. If the application needs a soft-cost assumption, it must be recorded explicitly as an application default or user assumption, never labeled E68-sourced.",
  };
}
