/**
 * InvestScape™ E88 Phase 6 — Source Registry.
 * © 2026 Lighthouse Research Ltd. All rights reserved.
 *
 * The definitive, machine-readable list of every construction-cost-relevant
 * source E88 has evaluated through Phase 6, extending (not replacing) the
 ...
 */
import { computeAnalyticalReadiness, type E88AnalyticalReadiness, type E88SourceDefinition } from "./source-adapter-types";

export const RLB_SOURCE_DEFINITION: E88SourceDefinition = {
  ...
  redistribution: {
    ...
    note: "Publicly downloadable PDF, no paywall or account required, but redistribution of the raw report/table data is not assumed permitted. E86/E88 store cited OBSERVATIONS (a $/SF figure with full citation), not a copy of the report — this has been E86's operating posture since Phase 4, unchanged here. A derived benchmark (Phase 5 output) is a distinct question from redistributing the report itself and is treated as VISIBLE, consistent with how E86/E88 have already been shipping benchmark-shaped output built on this source since Phase 2.",
  },
  ingested: true,
  statusNote: "The only source with ingested E88 cost observations (53 from E86 Phase 4 + 112 from E88 Phase 3 backfill = 165 hard-cost observations, plus 21 index/change observations). USE.",
};

export const TURNER_TOWNSEND_SOURCE_DEFINITION: E88SourceDefinition = {
  ...
  ingested: false,
  statusNote: "REGISTERED / DEFERRED. Real headline $/m² figures exist publicly for a handful of cities but are not a structured table this codebase can honestly normalize into E88's canonical taxonomy without inventing a category correspondence the source doesn't itself provide (Phase 3 Section 3).",
};

export const RSMEANS_SOURCE_DEFINITION: E88SourceDefinition = {
  ...
  redistribution: {
    ...
    redistributionAllowed: false,
    attributionRequired: false,
    note: "Paid subscription database. E86 Phase 6's own seven-question CRELicensingProfile framework already found every permission (internal consumption, display benchmark, display underlying value, store raw data, redistribute raw data, display derived calculations, expose provenance) REQUIRES_LICENSE_REVIEW or NO. Not re-litigated here — carried forward unchanged.",
  },
  ingested: false,
...
export const ALTUS_SOURCE_DEFINITION: E88SourceDefinition = {
  ...
  redistribution: {
    ...
    redistributionAllowed: false,
    attributionRequired: false,
    note: "Subscription/licensed. Best-positioned Canadian licensed candidate per Phase 1 Section 21 — unchanged. E86 Phase 6's licensing-permission framework applies identically to this source and was not re-litigated this phase.",
  },
  ingested: false,
  statusNote: "REGISTERED / LICENSE_REQUIRED / DEFERRED. No purchase or new research performed this phase.",
};

export const STATCAN_BCPI_SOURCE_DEFINITION: E88SourceDefinition = {
...
export const CMHC_SOURCE_DEFINITION: E88SourceDefinition = {
...
export const E88_SOURCE_REGISTRY: readonly E88SourceDefinition[] = [
...
export interface E88SourceReadinessRow {
  sourceId: string;
  publisher: string;
  productName: string;
  ...
  analyticalReadiness: E88AnalyticalReadiness;
  statusNote: string;
}
 ...
 */
export function buildSourceReadinessMatrix(registry: readonly E88SourceDefinition[] = E88_SOURCE_REGISTRY): readonly E88SourceReadinessRow[] {
...
export function findSourceDefinition(sourceId: string, registry: readonly E88SourceDefinition[] = E88_SOURCE_REGISTRY): E88SourceDefinition | undefined {
