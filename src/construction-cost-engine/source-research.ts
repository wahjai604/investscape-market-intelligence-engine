/**
 * InvestScape™ E70 Phase 3 — Source research register.
 ...
 * observation lives in this file. See docs/E70-phase3-coverage-and-source-
...
export interface SourceResearchRecord {
  ...
  e70Compatibility: string;
  decision: SourceDecision;
  rationale: string;
}

export const E70_PHASE3_SOURCE_RESEARCH: readonly SourceResearchRecord[] = [
  {
    ...
    observationAvailability: "Re-fetched 2026-09-11; hard-cost table cross-validated exact match against E68's existing Austin/Miami/Seattle/Phoenix figures before trusting the 16 additional cities.",
    publicationCadence: "Quarterly",
    licensing: "Publicly downloadable PDF report. No paywall, no account required.",
    redistribution: "Not confirmed permitted as raw redistribution — E68/E70 store cited observations, not a copy of the report (unchanged from Phase 1 finding).",
    acquisitionMechanism: "Direct PDF download from rlb.com, no authentication.",
    e70Compatibility: "Direct — reuses existing RLB_SUBTYPE_MAPPING taxonomy entries for the 7 building types already mapped.",
    decision: "USE",
    rationale: "Already in use since E68 Phase 4; Phase 3 backfills the same report's already-legitimate coverage to 16 additional cities (14 US + 2 Canada) at exact/close/approximate confidence identical to the original 4 cities. No new licensing question — same report, same terms.",
  },
  {
  ...
  },
  {
    ...
    e70Compatibility: "None identified — no construction-cost-shaped series found",
    decision: "REJECT",
    rationale: "No per-SF/per-unit construction-cost series was identified; CMHC's public data is about housing market activity (starts, completions, investment), not construction cost. Rejected for E70's purposes specifically (a future housing-market-intelligence engine may still find it useful — out of E70's scope).",
  },
  {
    ...
    observationAvailability: "Confirmed to exist per E68 Phase 6 `paid-source-analysis.ts`; not re-researched this phase (no new information — Phase 3 Part 3 caps licensed-source work at metadata only).",
    publicationCadence: "Continuously updated (subscription database), annual print editions",
    licensing: "Paid subscription",
    redistribution: "REQUIRES_LICENSE_REVIEW per E68 Phase 6's own seven-question framework — unresolved, not re-litigated this phase",
    ...
    e70Compatibility: "High, if licensed — would need its own taxonomy mapping table",
    decision: "REGISTER",
    rationale: "Carried forward unchanged from E68 Phase 6 / Phase 1 Section 21. No purchase, no account creation, no new research this phase — remains a Phase 6 (E70 roadmap) concern.",
  },
  {
    sourceId: "altus-group",
    sourceName: "Altus Group",
    dataType: "Licensed Canadian construction-cost data (confirmed to exist per E68 Phase 6)",
    geography: "Canada-primary",
    buildingCategories: "Not re-researched this phase",
    observationAvailability: "Confirmed to exist per E68 Phase 6; not re-researched this phase",
    publicationCadence: "Not re-researched this phase",
    licensing: "Subscription/licensed",
    redistribution: "REQUIRES_LICENSE_REVIEW per E68 Phase 6 — unresolved, not re-litigated this phase",
    acquisitionMechanism: "Paid subscription — explicitly not performed",
    e70Compatibility: "Best-positioned Canadian licensed candidate per Phase 1 Section 21, unchanged",
    decision: "REGISTER",
    rationale: "Carried forward unchanged from Phase 1/E68 Phase 6. No purchase, no account creation, no new research this phase.",
  },
] as const;
